...
export default function CustomerRegister() {
  ...
  const onSubmit = async (data: RegisterFields) => {
    ...
    try {
      ...
      setSuccessMsg(
        'Account created successfully! Check console for mock email verification. Redirecting...'
      );
      setTimeout(() => {
    ...
    <main className="min-h-screen bg-background flex flex-col justify-center items-center px-4 py-12">
      <div className="w-full max-w-md bg-surface border border-border-custom rounded-3xl p-8 shadow-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-extrabold text-primary-text">Create your account</h1>
          <p className="text-sm text-body-text mt-1">Start booking unique venues for your events</p>
        </div>
