    ...
    <main className="min-h-screen bg-background flex flex-col justify-center items-center px-4 py-12">
      <div className="w-full max-w-md bg-surface border border-border-custom rounded-3xl p-8 shadow-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-extrabold text-primary-text">Welcome back</h1>
          <p className="text-sm text-body-text mt-1">Please enter your details to sign in</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-1.5">
              <label
                className="block text-xs font-bold text-secondary-text uppercase"
                htmlFor="password"
              >
                Password
              </label>
