...
export default function OwnerNewVenue() {
  const [loading, setLoading] = useState(false);
  const [errorMsg, setErrorMsg] = useState<string | null>(null);
  const [successMsg, setSuccessMsg] = useState<string | null>(null);

  // Images upload states (Base64)
  ...
  const onSubmit = async (data: VenueFormFields) => {
    ...
    try {
      // Re-map flat form details to backend nested model
      const payload = {
        title: data.title,
        ...
        location: {
          coordinates: [parseFloat(data.longitude), parseFloat(data.latitude)], // GeoJSON Point Coordinates: [lng, lat]
        },
      ...
      if (!res.ok) {
        throw new Error(result.message || 'Creation of venue failed');
      }

      setSuccessMsg('Venue listing created successfully! Redirecting to dashboard...');
      setTimeout(() => {
  ...
  return (
    <main className="min-h-screen bg-background text-primary-text pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 mt-10">
        ...
        {successMsg && (
          <div className="p-4 mb-6 bg-green-50 border-l-4 border-green-500 rounded-2xl text-xs text-green-700 font-semibold">
            {successMsg}
          </div>
        )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  id="category"
                  type="text"
                  placeholder="e.g. Luxury Banquets, Nature Resorts"
                  {...register('category')}
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  id="description"
                  rows={4}
                  placeholder="Tell clients about your venue, packages, services, and special highlights..."
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="md:col-span-3">
                ...
                <input
                  id="street"
                  type="text"
                  placeholder="e.g. 12/A Main Road"
                  {...register('street')}
